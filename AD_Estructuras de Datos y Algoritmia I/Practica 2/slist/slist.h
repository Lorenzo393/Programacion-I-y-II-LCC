...
/**
 * Contatena dos listas modificando la primera.
 */
void slist_concatenar(SList lista1, SList lista2);

/**
 * Inserta un nuevo dato en la lista en una posicion arbitraria.
 */
 ...
 * esta en la lista dada, y -1 en caso que no este.
 */
int slist_indice(SList lista, int dato); 

/**
 * Devuelve una nueva lista con los elementos comunes (independientemente de
 * la posicion) de dos listas dadas por parametro. Las listas originales 
 * no se modifican.
 */
SList slist_intersecar(SList lista1, SList lista2);

/**
 * Trabaja como la anterior pero recibe un parametro extra que es un
 * puntero a una funcion de comparacion que permite definir la nocion de 
 * igualdad a ser usada al comparar elementos por igualdad.
 */
 ...
 * tendra longitud n + 1 y la segunda n. Retorna un puntero al primer elemento de la 
 * segunda mitad, siempre que sea no vacia.
 */
